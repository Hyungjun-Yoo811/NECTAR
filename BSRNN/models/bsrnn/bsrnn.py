"""Band-split RNN (BSRNN) target-speaker extractor: an STFT sub-band
separator conditioned on a speaker embedding via SpeakerFuseLayer. The
speaker embedding is train.py's clue_mode-dependent conditioning vector
(positive-only, or positive+negative concatenated)."""
