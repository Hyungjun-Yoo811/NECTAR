...
"""CAM++ speaker embedding network: an FCM convolutional front end feeding
a CAM-augmented DenseTDNN backbone, used here as the frozen encoder whose
frame-level features CSM builds on."""
