...
"""Audio preprocessing utilities: waveform loading/cropping (WavReader),
speaker-label encoding, and log-mel filterbank extraction (FBank) -- CSM's
frozen speaker encoders consume FBank's output."""
