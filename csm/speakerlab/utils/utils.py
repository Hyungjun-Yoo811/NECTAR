...
"""General-purpose training/eval helpers: seeding, logging, utt2spk/wav.scp
parsing, accuracy/average-precision metrics, checkpoint loading, and
AverageMeter-style stat tracking."""
